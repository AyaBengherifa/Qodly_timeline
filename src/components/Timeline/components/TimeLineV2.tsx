    ...
    <div ref={connect} style={style} className={cn(className, classNames)}>
      {variant === 'value3' &&
        entities.map((item, index) => (
          <div className="w-52 relative" key={item.__KEY}>
            {index < entities.length - 1 && (
              <div className=" absolute border-gray-400 h-48 top-2 border left-1/2"></div>
            )}
            <div className="mb-5 flex justify-between items-center right-timeline">
              ...
              <div className="mb-5 flex justify-between flex-row-reverse items-center w-full left-timeline">
                <div className="w-5/12"></div>
                <div className="z-20 flex items-center order-1 bg-gray-400 w-4 h-4 rounded-full"></div>
                <div className="order-1 rounded-lg w-5/12 ">
