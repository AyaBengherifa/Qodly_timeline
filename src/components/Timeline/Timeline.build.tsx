            ...
            <div className="flex flex-col items-start">
              <div className="flex items-center mb-8 relative">
                ...
                <div className="flex-grow flex justify-center">
                  <div className=" w-3 h-3 bg-gray-400 rounded-full flex items-center justify-center mb-2">
          ...
          {variant == 'value3' && (
            <div className="w-2/6 relative  ">
              ...
              <div className="mb-8 flex justify-between items-center right-timeline">
                ...
                <div className="z-20 flex items-center order-1 bg-gray-400  w-4 h-4 rounded-full">
                </div>
