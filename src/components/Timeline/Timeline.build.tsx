  ...
  return (
    <>
      <div ref={connect} style={style} className={cn(className, classNames)}>
        {datasource ? (
          <div>
            {(variant == 'value1' || variant == '') && orientation == 'Horizontal' && (
            ...
            {variant == 'value2' && orientation == 'Horizontal' && (
              <div className="relative flex items-end top-5">
                <div className="absolute text-sm mb-2 ml-3">
                  <IteratorProvider>
                    <Element
                      id="item1"
            ...
            {variant == 'value3' && (
              <div className="w-2/6 relative  ">
                ...
                <div className="mb-8 flex justify-between items-center right-timeline">
                  ...
                  <div className=" flex items-center order-1 bg-gray-400  w-4 h-4 rounded-full"></div>
