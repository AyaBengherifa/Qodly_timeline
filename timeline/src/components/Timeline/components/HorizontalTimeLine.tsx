            ...
            entities.map((item, index) => (
              <div className="relative flex items-end top-12" key={item.__KEY}>
                ...
                <div className="mt-3 sm:pe-8">
                  <div className="absolute top-1 left-1.5 z-10 flex items-center border-gray-200  border-2 shadow-2xl justify-center w-4 h-4 bg-gray-400  rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 ">
          ...
          {variant == 'value2' &&
            entities.map((item, index) => (
              <div className="relative flex items-end" key={item.__KEY}>
                ...
                <div className="mt-3 sm:pe-8">
                  <div className="absolute top-1 left-2.5 z-10 flex items-center justify-center border-gray-200 border-2 shadow-2xl w-4 h-4 bg-gray-400  rounded-full ring-0 ring-white dark:bg-blue-900 sm:ring-8 dark:ring-gray-900 ">
